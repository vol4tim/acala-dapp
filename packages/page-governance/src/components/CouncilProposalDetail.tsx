...
import { ProposalData, useProposal } from '@acala-dapp/react-hooks';
import { Card, Col, FlexBox, Row, styled } from '@acala-dapp/ui-components';
    ...
    <Row gutter={[24, 24]}>
      ...
      <Col span={24}>
        <Card header='Arguments'>
          <ArgumentsContent>
            {JSON.stringify(data.proposal.toHuman())}
          </ArgumentsContent>
        </Card>
      </Col>
      <Col span={24}>
